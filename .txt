...
@section('content')
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-8 py-16 px-6 lg:px-16 mt-4">
        ...
        <div class="space-y-6">
            ...
            <p class="text-xl sm:text-2xl poppins-light text-gray-900">On a mission to help start-ups in their vision of
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mb-4">
                ...
                <div class="bg-white p-2 rounded-lg shadow-lg flex flex-col items-center text-center w-full">
                    ...
                    <p class="text-gray-700  text-sm poppins-medium">Cloud communication platform delivering1 SMS every
                        month.</p>
                ...
                <div class="bg-white p-2 rounded-lg shadow-lg flex flex-col items-center text-center  w-full">
                    ...
                    <p class="text-gray-600  text-sm poppins-mono">ROR, Angular, ES6, pgSQL, and Node. 5000 API hits
                        free/month.</p>
                    <button
                        class="mt-4 border border-red-500 text-red-800 px-4 poppins-thin py-2 rounded-lg text-sm  hover:bg-red-500 hover:text-white transition-colors duration-300">
                        Know more
                    </button>
                </div>
