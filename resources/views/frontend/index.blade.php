...
@section('content')
   ...
   <section class="grid grid-cols-1 lg:grid-cols-2 gap-8 py-16 px-6 lg:px-16 lg:mt-44 mt-24">
    <div class="space-y-6">
      <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 poppins-medium">We are a team of Developers, Designers, Innovators...</h2>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mb-4">
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg flex flex-col items-center text-center w-full">
                ...
                <p class="text-gray-700  text-sm poppins-medium">Cloud communication platform delivering1 SMS every month.</p>
                <p class="text-gray-600  text-sm poppins-mono">PHP, MySQL, MongoDB, AWS and Python.</p>
                <button class="mt-4 border border-red-500  text-red-800 px-4 py-2 rounded-lg text-sm poppins-thin hover:bg-red-500 hover:text-white transition-colors duration-300">
                    Know more
                </button>
            </div>
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg flex flex-col items-center text-center  w-full">
                ...
                <p class="text-gray-600  text-sm poppins-mono">ROR, Angular, ES6, pgSQL, and Node. 5000 API hits free/month.</p>
                <button class="mt-4 border border-red-500 text-red-800 px-4 poppins-thin py-2 rounded-lg text-sm  hover:bg-red-500 hover:text-white transition-colors duration-300">
                    Know more
                </button>
            </div>
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg flex flex-col items-center text-center">
                ...
                <p class="text-gray-700 text-sm poppins-medium">Team collaboration app with best facalities.</p>
                <p class="text-gray-600 text-sm poppins-mono">PHP, MySQL, MongoDB, AWS, NGINX, MERN, Angular and Python.</p>
                <button class="mt-4 poppins-thin border border-red-500 text-red-800 px-4 py-2 rounded-lg text-sm  hover:bg-red-500 hover:text-white transition-colors duration-300">
                    Know more
                </button>
            </div>
        </div>
...
<section class="grid grid-cols-1 lg:grid-cols-2 gap-8 py-16 px-6 lg:px-16 mt-4">
 ...
 <section class="py-16 px-6 lg:px-16 ">
    <div class="max-w-screen-xl mx-auto">
        ...
        <!-- Third Section -->
        <article class="mb-12">
            <h2 class="text-2xl poppins-serif text-gray-900 mb-4">The way you do anything is the way you do everything.</h2>
            ...
            <button class="bg-red-600 poppins-thin hover:bg-black text-white px-6 py-3 rounded-lg text-lg transition-colors duration-300">
                Apply Now
            </button>
        </article>
